...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TREC_SUPPORTED_ARCH)
  if (OS_NAME MATCHES "Linux|Darwin|FreeBSD|NetBSD")
...
if (OS_NAME MATCHES "Linux|FreeBSD|Windows|NetBSD|SunOS")
  ...
  set(COMPILER_RT_TREC_HAS_STATIC_RUNTIME TRUE)
else()
  set(COMPILER_RT_TSAN_HAS_STATIC_RUNTIME FALSE)
  set(COMPILER_RT_TREC_HAS_STATIC_RUNTIME FALSE)
endif()
